...
public enum CSVError: Error, LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .encodingError:
            ...
            return String(localized: "CSV Encoding Error", bundle: .module, comment: "Error when CSV encoding/decoding fails")
            #else
            return "CSV Encoding Error"
            #endif
        case .invalidURL:
            #if os(macOS) || os(iOS) || os(tvOS) || os(watchOS) || os(visionOS)
            return String(localized: "Invalid URL", bundle: .module, comment: "Error when URL is invalid")
            #else
            return "Invalid URL"
            #endif
        case .networkError:
            #if os(macOS) || os(iOS) || os(tvOS) || os(watchOS) || os(visionOS)
            return String(localized: "Network Error", bundle: .module, comment: "Error during network operation")
            #else
    ...
    public var failureReason: String? {
        ...
        case .encodingError:
            #if os(macOS) || os(iOS) || os(tvOS) || os(watchOS) || os(visionOS)
            return String(localized: "The data could not be encoded or decoded using the specified text encoding.",
                          bundle: .module,
        ...
        case .invalidURL:
            #if os(macOS) || os(iOS) || os(tvOS) || os(watchOS) || os(visionOS)
            return String(localized: "The URL provided is not valid or uses an unsupported scheme.",
                          bundle: .module,
        ...
        case .networkError:
            #if os(macOS) || os(iOS) || os(tvOS) || os(watchOS) || os(visionOS)
            return String(localized: "Failed to download data from the network.",
                          bundle: .module,
    ...
    public var recoverySuggestion: String? {
        ...
        case .encodingError:
            #if os(macOS) || os(iOS) || os(tvOS) || os(watchOS) || os(visionOS)
            return String(localized: "Ensure the file is saved with the correct text encoding and contains valid characters for that encoding.",
                          bundle: .module,
                          comment: "CSV encoding error suggestion")
            #else
            return "Ensure the file is saved with the correct text encoding and contains valid characters for that encoding."
            #endif
        case .invalidURL:
            #if os(macOS) || os(iOS) || os(tvOS) || os(watchOS) || os(visionOS)
            return String(localized: "Check that the URL is properly formatted and uses the correct scheme (file://, http://, or https://).",
                          bundle: .module,
                          comment: "Invalid URL error suggestion")
            #else
            return "Check that the URL is properly formatted and uses the correct scheme (file://, http://, or https://)."
            #endif
        case .networkError:
            #if os(macOS) || os(iOS) || os(tvOS) || os(watchOS) || os(visionOS)
            return String(localized: "Check your network connection and ensure the URL is accessible.",
                          bundle: .module,
