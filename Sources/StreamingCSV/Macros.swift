...
public macro CSVRowBuilder() =
  #externalMacro(module: "StreamingCSVMacros", type: "CSVRowBuilderMacro")
 ...
 */
@attached(peer)
public macro Fields(_ count: Int) =
  #externalMacro(module: "StreamingCSVMacros", type: "FieldsMacro")
...
public macro CSVRowDecoderBuilder() =
  #externalMacro(module: "StreamingCSVMacros", type: "CSVRowDecoderBuilderMacro")
...
public macro CSVRowEncoderBuilder() =
  #externalMacro(module: "StreamingCSVMacros", type: "CSVRowEncoderBuilderMacro")
